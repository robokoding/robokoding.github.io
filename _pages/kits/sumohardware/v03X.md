...
When you have the SumoBoard v0.3 then you also have to do the following step. Solder 2 cables to connect the following pins.
...
When you have the SumoBoard v0.3 then you also have to do the following step. Add more solder to connect the lower right 2 pins together.
...
Fasten the battery on top of the servo motors with zip ties or rubber bands, either which was supplied with the kit. Finally place the red and black wire from the battery from top trough the SumoBoard holes to connect them to J6 and J7. Bend the cables into the holes and solder them. J7 can be in a different location, depending on the exact version of SumoBoard you have.
