...
Fasten the battery on top of the servomotors with zip ties or rubber bands, either which was supplied with the kit. Finally place the red and black wire from the battery from top trough the SumoBoard holes to connect them to J6 and J7. Bend the cables into the holes and solder them. J7 can be in a different location, depending on the exact version of SumoBoard you have.
