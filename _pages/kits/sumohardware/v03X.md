...
IMPORTANT! Do this only if you have the SumoBoard v0.3. Solder 2 cables to connect the following pins.
...
IMPORTANT! Do this only when you have the SumoBoard v0.3. Add more solder to connect the lower right 2 pins together.
