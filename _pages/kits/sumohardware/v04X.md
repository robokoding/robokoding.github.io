...
Cut the remainder of the resistor's legs and keep the remainders on the side, for a later step. Inside the boundaries of the right and left servo, try to cut the solder joints as flat as possible. So the servomotors can fit on better later.
